...
@pytest.mark.asyncio
async def test_user_can_mark_notification_as_read(db_fixture: AsyncSession, authenticated_user_fixture: User):
    ...
    response = client.post(f"{base_url}/{notification_delivery.id}/read")
