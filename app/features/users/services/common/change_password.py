...
class PasswordIncorrectException(ServiceException):
    ...
    type = "users/common/change-password/password-incorrect"
    detail = "Old password is incorrect, you must provide the correct current password"


class PasswordsIdenticalException(ServiceException):
    status_code = status.HTTP_400_BAD_REQUEST
    type = "users/common/change-password/passwords-identical"
