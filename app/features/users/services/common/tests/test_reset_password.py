...
@pytest.mark.asyncio
async def test_user_can_reset_password(db_fixture: AsyncSession, background_fixture: NoOpBackground):
...
@pytest.mark.asyncio
async def test_user_cannot_reset_password_with_nonexistent_email(background_fixture: NoOpBackground):
